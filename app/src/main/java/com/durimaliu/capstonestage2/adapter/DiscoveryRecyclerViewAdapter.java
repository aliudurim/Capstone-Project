...
public class DiscoveryRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setGetAllTripListByType(List<GetAllTrip> getAllTripList) {
    ...
    public DiscoveryRecyclerViewAdapter(Context _ctx) {
        ctx = _ctx;
    }

    public class RecycleHolder extends RecyclerView.ViewHolder {

        @Bind(R.id.rlCellDiscovery)
        RelativeLayout rlCellDiscovery;
        ...
        public RecycleHolder(View v) {
            ...
            rlCellDiscovery.setLayoutParams(new RelativeLayout.LayoutParams(Utilitys.screenWidth, (int) (Utilitys.screenHeight * 0.2312f)));
        }
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.discovery_cell, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((RecycleHolder) holder).rlCellDiscovery.setOnClickListener(new View.OnClickListener() {
            @Override
